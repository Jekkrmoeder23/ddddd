(function () {
  ...
  style.textContent =
    ...
    '.at-sw{font-size:14px;position:relative;display:inline-block;width:3.5em;height:2em}' +
    '.at-sw input{opacity:0;width:0;height:0;position:absolute}' +
    '.at-sw .slider{position:absolute;cursor:pointer;inset:0;border:2px solid #2a2a3a;border-radius:50px;background:#111;transition:all 0.4s cubic-bezier(0.175,0.885,0.32,1.275)}' +
    '.at-sw .slider:before{position:absolute;content:"";height:1.4em;width:1.4em;left:0.2em;bottom:0.2em;background-color:rgba(255,255,255,0.25);border-radius:inherit;transition:all 0.4s cubic-bezier(0.23,1,0.320,1)}' +
    '.at-sw input:checked+.slider{box-shadow:0 0 16px rgba(99,102,241,0.6);border:2px solid #6366f1;background:rgba(99,102,241,0.15)}' +
    '.at-sw input:checked+.slider:before{transform:translateX(1.5em);background-color:#6366f1;box-shadow:0 0 8px rgba(99,102,241,0.8)}' +
