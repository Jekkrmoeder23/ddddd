(function () {
  ...
  style.textContent =
    ...
    '#at-panel{width:224px;background:#0a0a0f;border:1px solid rgba(255,255,255,0.07);border-radius:14px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,0.8),inset 0 1px 0 rgba(255,255,255,0.05);display:none}' +
    ...
    '#at-manual{width:100%;padding:7px 0;border-radius:7px;font:600 9px "Courier New",monospace;letter-spacing:0.1em;cursor:pointer;transition:all 0.2s;background:rgba(255,255,255,0.03);color:rgba(255,255,255,0.25);border:1px solid rgba(255,255,255,0.06)}' +
